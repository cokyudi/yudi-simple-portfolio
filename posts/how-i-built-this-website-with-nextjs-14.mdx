...
tags: ["nextjs", "react", "web-development", "portfolio"]
---
...
├─ layout.tsx        # Root layout (metadata, global layout)
├─ page.tsx          # Homepage (work experience, CV download)
├─ blog/             # Blog routes
│  ├─ page.tsx       # Blog list page
│  └─ [slug]/        # Individual blog post pages
│     └─ page.tsx
├─ not-found.tsx     # Custom 404 page
components/          # Reusable UI components (Figure, Header, Footer, etc.)
constants/           # Links, i18n, and static constants
context/             # Global state for language
lib/                 # Utilities (MDX parsing, helpers, SEO utils)
posts/               # Blog content written in MDX
public/              # Static assets (images, logo, CV PDF)
