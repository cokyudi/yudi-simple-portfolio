...
In Indonesia, names don’t always follow the “first name–last name” system that many countries use. Some people even have just one name. If that sounds confusing, you’re not alone—there’s a good explanation [here](https://en.wikipedia.org/wiki/Indonesian_names#:~:text=Legally%2C%20Indonesian%20personal%20names%20are,Suharto%20is%20another%20example.).
