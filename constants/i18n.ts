/** The two languages the site ships copy in. */
...
/**
 * English is the source of truth for the copy shape. Typing `ja` against it
 * turns a missing or misspelled key into a compile error instead of a silent
 * fallback at runtime — which matters most for `tags`, where a gap would show
 * a raw slug to Japanese readers.
 */
...
export const i18n: Record<Language, Translations> = { en, ja };
